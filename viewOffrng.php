      ...
      <div id="mainpage" data-role="page" data-theme="a"><!-- mainpage -->
        <div class="upage-outer" id="uib_page_2">
          ...
          <div data-role="header" data-theme="a">
             <h1>View Offering</h1>
            <a href="index.html" data-icon="carat-l" class="ui-btn-left" style="background-color:#000000;" data-transition="fade" data-rel="back">Home</a>
          ...
          <div>
          	<h5 style="text-align:center; margin-left:30px; margin-right:30px;">What Would You Like to Do Now?</h5>
           </div>
          <div style="margin-top:30px; margin-bottom:10px; margin-left:30px; margin-right:30px;"> 
                    	<fieldset data-role="controlgroup">
        					<a href="offeringUpdate.php" class="ui-btn ui-corner-all ui-shadow ui-btn-mini ui-btn-a" data-transition="pop" data-theme="a">Make Changes to This Offering</a>
        					<a href="addOffering.html" class="ui-btn ui-corner-all ui-shadow ui-btn-mini ui-btn-a" data-transition="pop" data-theme="a" >Add Another Offering</a>
        					<a href="providerDetail.php" class="ui-btn ui-corner-all ui-shadow ui-btn-mini ui-btn-a" data-transition="pop" data-theme="a" >View Updated Profile Page</a>
    					</fieldset>
					</div>	
